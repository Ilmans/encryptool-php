...
<?php if (isset($_POST['code'])) {
    ...
    $level = $_POST['level'] + 1;
        $mpediaencrypt = openssl_encrypt( $code,$cipher,$key, 0,'ABCDEF0123456789' );
        $encoded_code = '<?php $mpediaencrypt = \'' . $mpediaencrypt . '\'; ' . 'eval(openssl_decrypt($mpediaencrypt, \'' . $cipher . '\', \'' . $key .  '\', 0, \'ABCDEF0123456789\')); ?>';
} ?>
<!DOCTYPE html>
<html>
<head>
